...
const PostCard = ({ post }) => {
  ...
  return (
    <div className='post-card shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>

        <div className='relative overflow-hidden shadow-md pb-80 mb-6'>
          <img
            src = {post.featuredImage.url}
            alt = {post.title}
            className = " top-0 absolute h-80 w-full object-cover shadow-lg rounded-t-lg lg:rounded-lg"
          />
        </div>
